...
const EditNote = () => {
    ...
    const [tittle, setTittle] = useState("Kuliner"); // gunakan 'tittle'
    ...
    useEffect(() => {
        const getNoteById = async () => {
            try {
                ...
                setTittle(response.data.tittle); // gunakan 'tittle'
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    ...
                    await axios.put(
                        `${BASE_URL}/notes/${id}`,
                        { date, tittle, content }, // gunakan 'tittle'
                        {
                            headers: {
                                Authorization: `Bearer ${token}`,
                            },
        ...
        <div className="columns is-centered mt-6">
            <div className="column is-half">
                <div className="box has-shadow p-5" style={{ borderRadius: "12px" }}>
                    <h2 className="title is-4 has-text-centered has-text-primary">Edit Catatan</h2>
